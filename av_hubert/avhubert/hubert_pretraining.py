...
# Always use relative imports to avoid double-registering fairseq tasks
...
class AVHubertPretrainingConfig(FairseqDataclass):
    ...
    input_modality: Optional[str] = field(default="audiovisual", metadata={"help": "input modality: audio | video | audiovisual"})
