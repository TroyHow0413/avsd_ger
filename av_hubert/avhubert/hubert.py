...
# Always use relative imports to avoid double-registering fairseq models
# when this package is imported via python -c (sys.argv length == 1)
...
class AVHubertConfig(FairseqDataclass):
    ...
    # Conformer-specific (only used when layer_type=conformer; kept for config merge compatibility)
