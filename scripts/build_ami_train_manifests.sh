...
echo ""
echo "Next steps:"
echo "  python scripts/ami_visual_to_jsonl.py \\"
echo "      --manifest-dir data/ami_train_visual \\"
echo "      --out data/ami_train_visual.jsonl"
echo ""
echo "  python scripts/train_identity.py \\"
echo "      --config one_go/runs/config_real_en.yaml \\"
echo "      --manifest data/ami_train_visual.jsonl \\"
echo "      --out checkpoints/stage1"
echo ""
echo "  python scripts/train_stage2.py \\"
echo "      --config one_go/runs/config_real_en.yaml \\"
echo "      --manifest data/ami_train_visual.jsonl \\"
echo "      --stage1-pool checkpoints/stage1/identity_pool_stage1.pt \\"
echo "      --ger-mode av \\"
